...
The Attendee and Round detail screens carry no back link: the Attendees and Rounds tabs are pinned one tap away and lead to the same place. The Poll screen keeps its back link, because the nav does not reach the Votes list. The organiser screens keep theirs too, even though the Organisers tab now reaches the hub they hang off. Do not add a back link to a screen whose parent is a nav tab.
