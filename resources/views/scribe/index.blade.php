                ...
                <li class="tocify-item level-1" data-unique="events">
                    <a href="#events">Events</a>
                                ...
                                <a href="#events-GETapi-game-systems">List Game Systems</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="events-GETapi-countries">
                                <a href="#events-GETapi-countries">List Countries</a>
                            </li>
                                ...
                                <a href="#events-PATCHapi-events--slug-">Edit an Event</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="events-POSTapi-events--event_slug--banner">
                                <a href="#events-POSTapi-events--event_slug--banner">Upload an Event Banner</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="events-DELETEapi-events--event_slug--banner">
                                <a href="#events-DELETEapi-events--event_slug--banner">Remove an Event Banner</a>
                            </li>
...
<p>Revoke the token the request was made with</p>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://battlezones.test/api/auth/logout';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://battlezones.test/api/auth/logout"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;is_archived&quot;: false,
        &quot;unread_count&quot;: 0,
        &quot;created_at&quot;: &quot;2026-09-23T21:59:19Z&quot;,
        &quot;updated_at&quot;: &quot;2026-09-23T21:59:19Z&quot;
    }
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="events-GETapi-countries">List Countries</h2>

<p>
</p>

<p>Every country a venue may be in, as an ISO 3166-1 alpha-2 code and the name to show for it, in name order. Public: it is the list a country picker offers.</p>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://battlezones.test/api/countries';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://battlezones.test/api/countries"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;timezone&quot;: &quot;UTC&quot;,
        &quot;starts_at&quot;: &quot;2026-10-10T11:29:10Z&quot;,
        &quot;ends_at&quot;: &quot;2026-10-12T11:29:10Z&quot;,
        &quot;max_attendees&quot;: 100,
        &quot;attendee_size&quot;: 1,
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;pinned&quot;: false,
        &quot;published_at&quot;: &quot;2026-09-05T19:30:33Z&quot;,
        &quot;author&quot;: {
            &quot;id&quot;: 1693,
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;url&quot;: &quot;http://battlezones.test/uploads/photos/445bd3f6-8f2c-38cb-aa04-2f4e1edb32bb.jpg?expires=1790204400&amp;signature=ce2234d32e9ae6b14cc45683e1fe33ed6aac03b19c67e02ba91a039bc8f35818&quot;,
        &quot;thumbnail_url&quot;: &quot;http://battlezones.test/uploads/photos/thumbs/deea2dce-ea5d-340f-90ce-c06cddd4c879.jpg?expires=1790204400&amp;signature=8a1f27927f5d87f22bad61caf521ae5ce1f6f43531a45066f308250fc7a9517f&quot;,
        &quot;created_at&quot;: &quot;2026-09-23T21:59:19Z&quot;,
        &quot;updated_at&quot;: &quot;2026-09-23T21:59:19Z&quot;
    }
}</code>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;pairing_format&quot;: &quot;swiss&quot;,
        &quot;timezone&quot;: &quot;UTC&quot;,
        &quot;starts_at&quot;: &quot;2027-03-02T13:37:05Z&quot;,
        &quot;ends_at&quot;: &quot;2027-03-04T13:37:05Z&quot;,
        &quot;max_attendees&quot;: 25,
        &quot;attendee_size&quot;: 1,
        &quot;requires_allegiance&quot;: false,
        &quot;registration_closes_at&quot;: null,
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
                    ...
                    <h2 id="events-POSTapi-events--event_slug--banner">Upload an Event Banner</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Organisers only. A multipart route of its own rather than a field on the Event PATCH, because PHP does not populate uploaded files for PATCH bodies. The upload is scaled and cropped to 1600x534 and 800x267 WebP and the original is discarded, so re-framing later means uploading again.</p>

<span id="example-requests-POSTapi-events--event_slug--banner">
<blockquote>Example request:</blockquote>


<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://battlezones.test/api/events/london-grand-tournament/banner';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'banner',
                'contents' =&gt; fopen('/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/phpt3fgmhng4amfakWMQz1', 'r')
            ],
        ],
    ]
);
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://battlezones.test/api/events/london-grand-tournament/banner"
);
...
<span id="example-responses-POSTapi-events--event_slug--banner">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;slug&quot;: &quot;velit-et-fugiat-48530&quot;,
        &quot;description&quot;: &quot;Mollitia modi deserunt aut ab provident perspiciatis quo. Nostrum aut adipisci quidem nostrum. Commodi incidunt iure odit. Et modi ipsum nostrum omnis autem et consequatur. Dolores enim non facere tempora.&quot;,
        &quot;status&quot;: &quot;draft&quot;,
        &quot;pairing_format&quot;: &quot;swiss&quot;,
        &quot;timezone&quot;: &quot;UTC&quot;,
        &quot;starts_at&quot;: &quot;2027-02-22T17:18:32Z&quot;,
        &quot;ends_at&quot;: &quot;2027-02-24T17:18:32Z&quot;,
        &quot;max_attendees&quot;: 100,
        &quot;attendee_size&quot;: 1,
        &quot;requires_allegiance&quot;: false,
        &quot;registration_closes_at&quot;: null,
...
<span id="execution-results-POSTapi-events--event_slug--banner" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-events--event_slug--banner"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-events--event_slug--banner"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-events--event_slug--banner" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-events--event_slug--banner">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-events--event_slug--banner" data-method="POST"
      data-path="api/events/{event_slug}/banner"
      data-authed="1"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-events--event_slug--banner', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-events--event_slug--banner"
                    onclick="tryItOut('POSTapi-events--event_slug--banner');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-events--event_slug--banner"
                    onclick="cancelTryOut('POSTapi-events--event_slug--banner');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-events--event_slug--banner"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/events/{event_slug}/banner</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-events--event_slug--banner"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-events--event_slug--banner"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="event_slug"                data-endpoint="POSTapi-events--event_slug--banner"
               value="london-grand-tournament"
               data-component="url">
    <br>
<p>The slug of the event. Example: <code>london-grand-tournament</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="banner"                data-endpoint="POSTapi-events--event_slug--banner"
               value=""
               data-component="body">
    <br>
<p>A wide image, at least 1200x400, at most 8MB. JPEG, PNG or WebP. Example: <code>/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/phpt3fgmhng4amfakWMQz1</code></p>
        </div>
        </form>

                    <h2 id="events-DELETEapi-events--event_slug--banner">Remove an Event Banner</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Organisers only. Deletes both stored variants and returns the header to its flat surface.</p>

<span id="example-requests-DELETEapi-events--event_slug--banner">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-events--event_slug--banner">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;pairing_format&quot;: &quot;swiss&quot;,
        &quot;timezone&quot;: &quot;UTC&quot;,
        &quot;starts_at&quot;: &quot;2027-03-21T00:40:35Z&quot;,
        &quot;ends_at&quot;: &quot;2027-03-23T00:40:35Z&quot;,
        &quot;max_attendees&quot;: 100,
        &quot;attendee_size&quot;: 1,
        &quot;requires_allegiance&quot;: false,
        &quot;registration_closes_at&quot;: null,
...
<span id="execution-results-DELETEapi-events--event_slug--banner" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-events--event_slug--banner"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-events--event_slug--banner"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-events--event_slug--banner" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-events--event_slug--banner">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-events--event_slug--banner" data-method="DELETE"
      data-path="api/events/{event_slug}/banner"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-events--event_slug--banner', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-events--event_slug--banner"
                    onclick="tryItOut('DELETEapi-events--event_slug--banner');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-events--event_slug--banner"
                    onclick="cancelTryOut('DELETEapi-events--event_slug--banner');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-events--event_slug--banner"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-events--event_slug--banner"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-events--event_slug--banner"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="event_slug"                data-endpoint="DELETEapi-events--event_slug--banner"
               value="london-grand-tournament"
               data-component="url">
    <br>
<p>The slug of the event. Example: <code>london-grand-tournament</code></p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;label&quot;: &quot;Awards&quot;,
        &quot;type&quot;: &quot;info&quot;,
        &quot;starts_at&quot;: &quot;2026-10-01T20:53:16+00:00&quot;,
        &quot;ends_at&quot;: &quot;2026-10-01T21:53:16+00:00&quot;,
        &quot;display_order&quot;: 0,
        &quot;target_id&quot;: null,
        &quot;target_state&quot;: null,
        &quot;round&quot;: null
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'avatar',
                'contents' =&gt; fopen('/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/php9gjjgf6qn775c5fWsE0', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A square-ish image, at least 128x128, at most 8MB. JPEG, PNG or WebP. Example: <code>/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/php9gjjgf6qn775c5fWsE0</code></p>
        </div>
        </form>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;url&quot;: &quot;http://battlezones.test/uploads/photos/2b9698b7-206f-39ef-afe7-680996a8a00c.jpg?expires=1790204400&amp;signature=c3a91cf2367b362fa18d2f9cae76f5930f324fdc06a986b1ef45d6636b9e59fc&quot;,
        &quot;thumbnail_url&quot;: &quot;http://battlezones.test/uploads/photos/thumbs/b791a78a-bdb6-3c15-a840-a911ad9b9a6e.jpg?expires=1790204400&amp;signature=a5f5a6323bbd0f6781157e1d541986bd29ecd9fec1f00c6d4a1abdede91524a9&quot;,
        &quot;created_at&quot;: &quot;2026-09-23T21:59:19Z&quot;,
        &quot;updated_at&quot;: &quot;2026-09-23T21:59:19Z&quot;
    }
}</code>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'photo',
                'contents' =&gt; fopen('/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/phpeknvf3oravsu5Hjlaer', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The photo file (jpg, jpeg, png, or webp, max 10MB). Must be an image. Must not be greater than 10240 kilobytes. Example: <code>/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/phpeknvf3oravsu5Hjlaer</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
$response = $client-&gt;patch(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'photo',
                'contents' =&gt; fopen('/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/php84mbeq1n5m7d2mrRLxo', 'r')
            ],
        ],
    ]
);
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A replacement photo file (jpg, jpeg, png, or webp, max 10MB). Must be an image. Must not be greater than 10240 kilobytes. Example: <code>/private/var/folders/tv/6pq_d1gn2zvcmbpxs5428yv80000gn/T/php84mbeq1n5m7d2mrRLxo</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        &quot;id&quot;: 361,
        &quot;name&quot;: &quot;Provident sit beatae accusamus.&quot;,
        &quot;description&quot;: &quot;Voluptatem dolores cupiditate ut amet. Ea culpa quo cumque ea error. Fugit doloribus aut error saepe minus voluptatem. Perferendis excepturi eius alias enim.&quot;,
        &quot;url&quot;: &quot;http://battlezones.test/uploads/photos/0700cf75-ca8f-30f6-b854-fb03793e7a7e.jpg?expires=1790204400&amp;signature=a164186916e4215ed02bf814af0c9916b9089e81f28695f7290c07b25157065b&quot;,
        &quot;thumbnail_url&quot;: &quot;http://battlezones.test/uploads/photos/thumbs/0d0f52f5-3733-318e-b133-67ff18cf2fb5.jpg?expires=1790204400&amp;signature=de50b72e9bb3aba4423d5cbd1edd2cc75b84b42739607bb69a968666eb9f3b0d&quot;,
        &quot;created_at&quot;: &quot;2026-09-23T21:59:19Z&quot;,
        &quot;updated_at&quot;: &quot;2026-09-23T21:59:19Z&quot;
    }
}</code>
